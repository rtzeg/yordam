  ...
  return (
    <MainLayout>
      <div className="w-full px-4 py-10 lg:px-12 xl:px-[72px]">
        <h1 className="font-display text-[32px] font-bold text-[#1F98FA] md:text-[40px]">
          Поиск специалиста
        </h1>
        ...
        <div className="mt-4 border-b border-[#46A9FF] pb-5">
          <div className="mb-3 flex items-center gap-1 text-[13px] text-[#9BA6B5]">
            <Link to="/" className="transition-colors hover:text-[#1F98FA]">
              Главная страница
            </Link>
            <span>›</span>
          ...
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            ...
            <div className="mt-2 flex items-center justify-between md:mt-0 md:ml-6 md:w-auto">
              <div className="flex items-center gap-1 text-[13px] text-[#B2BDCC]">
                <span>Найдено</span>
                <span className="font-medium text-[#071A34]">{totalFound}</span>
              ...
              <div className="relative">
                <button
                  ...
                  className="inline-flex items-center gap-2 rounded-full bg-[#1F98FA] px-6 py-3 text-[14px] font-semibold text-white shadow-[0_12px_24px_rgba(31,152,250,0.45)] transition-colors hover:bg-[#0f84e2]"
                >
                  {currentSortLabel}
        ...
        <div className="mt-8 flex flex-col gap-8 lg:flex-row">
            ...
            <div className="space-y-5">
              {filterConfig.map((group) => {
                ...
                return (
                  <div
                    key={group.key}
                    className="border-b border-[#EDF1F7] pb-4"
                  >
                    <button
                      type="button"
          ...
          <section className="flex-1">
            {visiblePsychologists.length === 0 ? (
              ...
              <>
                <div className="grid grid-cols-1 justify-items-center gap-6 md:grid-cols-2 xl:justify-items-start xl:grid-cols-3">
